...
import { DETAIL_FIELD_CREATED , DETAIL_FIELD_READ , DETAIL_FIELD_UPDATED , DETAIL_FIELD_REMOVED, UpdateDetailFieldDto, CreateDetailFieldDto, DetailFieldIdDto } from '@sephrmicroservice-monorepo/common';
