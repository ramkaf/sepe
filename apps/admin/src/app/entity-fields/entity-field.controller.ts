...
import { CreateEntityFieldArrayDto, CreateEntityFieldDto, ENTITY_FIELD_CREATED, ENTITY_FIELD_MULTIPLE_CREATED, ENTITY_FIELD_MULTIPLE_REMOVED, ENTITY_FIELD_MULTIPLE_UPDATED, ENTITY_FIELD_READ, ENTITY_FIELD_REMOVED, ENTITY_FIELD_UPDATED, ENTITY_TYPE_MULTIPLE_CREATED, EntityFieldIdDto, GetEntityFieldArrayByIdDto, ReadEntityFieldDto, UpdateEntityFieldDto, UpdateMultipleEntityFieldArrayDto } from '@sephrmicroservice-monorepo/common';
...
export class EntityFieldMicroserviceController {
  ...
  //   }
    ...
    // async deleteMany(
    //   @Payload() getEntityFieldArrayByIdDto: GetEntityFieldArrayByIdDto
    // ) {
