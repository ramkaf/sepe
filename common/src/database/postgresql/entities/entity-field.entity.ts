...
export class EntityField {
  ...
  @Column({ name: 'field_title', type: 'varchar', nullable: true })
  ...
  @Column({ name: 'is_computational', type: 'boolean' })
  ...
  @Column({ name: 'browser_group', type: 'varchar', nullable: true })
  ...
  // @ManyToOne(() => AlarmConfig, { nullable: true, onDelete: 'SET NULL' })
  // @JoinColumn({ name: 'ac_id' })
  // alarm_config: AlarmConfig | null;

  @Column({ name: 'entity_type_id', type: 'int', nullable: true }) // ✅ این خط اضافه شده
  entity_type_id: number | null;

  @ManyToOne(() => EntityType, { nullable: true })
